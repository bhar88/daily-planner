$(document).ready(function() {
    ...
    // Interval to fun the hourUpdater function every 10 seconds to adjust for increasing time
    setInterval(function(){
      hourUpdater();
    }, 10000);
    
    // Retrieve stored data from localStorage and put it into the correct hour-row
